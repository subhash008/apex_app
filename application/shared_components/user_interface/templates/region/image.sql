...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093165838321281046)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093166142478281046)
,p_plug_template_id=>wwv_flow_imp.id(103093165838321281046)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093166444333281046)
,p_plug_template_id=>wwv_flow_imp.id(103093165838321281046)
,p_name=>'Sub Regions'
