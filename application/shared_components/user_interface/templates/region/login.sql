...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093190442994281055)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093190730755281055)
,p_plug_template_id=>wwv_flow_imp.id(103093190442994281055)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093191025414281055)
,p_plug_template_id=>wwv_flow_imp.id(103093190442994281055)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093191386883281056)
,p_plug_template_id=>wwv_flow_imp.id(103093190442994281055)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093191610380281056)
,p_plug_template_id=>wwv_flow_imp.id(103093190442994281055)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093191965294281056)
,p_plug_template_id=>wwv_flow_imp.id(103093190442994281055)
,p_name=>'Sub Regions'
