...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093130471367281031)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093130772834281031)
,p_plug_template_id=>wwv_flow_imp.id(103093130471367281031)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093131099799281031)
,p_plug_template_id=>wwv_flow_imp.id(103093130471367281031)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093131398916281031)
,p_plug_template_id=>wwv_flow_imp.id(103093130471367281031)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093131669433281031)
,p_plug_template_id=>wwv_flow_imp.id(103093130471367281031)
,p_name=>'Sub Regions'
