...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093185843350281053)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093186124291281054)
,p_plug_template_id=>wwv_flow_imp.id(103093185843350281053)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093186482276281054)
,p_plug_template_id=>wwv_flow_imp.id(103093185843350281053)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093186752853281054)
,p_plug_template_id=>wwv_flow_imp.id(103093185843350281053)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093187014356281054)
,p_plug_template_id=>wwv_flow_imp.id(103093185843350281053)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093187399999281054)
,p_plug_template_id=>wwv_flow_imp.id(103093185843350281053)
,p_name=>'Sub Regions'
