...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093205418139281062)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093205763273281062)
,p_plug_template_id=>wwv_flow_imp.id(103093205418139281062)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093206071984281062)
,p_plug_template_id=>wwv_flow_imp.id(103093205418139281062)
,p_name=>'Tabs'
