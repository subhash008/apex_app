...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093136142410281033)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093136437977281034)
,p_plug_template_id=>wwv_flow_imp.id(103093136142410281033)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093136707326281034)
,p_plug_template_id=>wwv_flow_imp.id(103093136142410281033)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093137031718281034)
,p_plug_template_id=>wwv_flow_imp.id(103093136142410281033)
,p_name=>'Sub Regions'
