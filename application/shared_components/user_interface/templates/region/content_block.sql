...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093157742575281042)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093158005220281042)
,p_plug_template_id=>wwv_flow_imp.id(103093157742575281042)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093158375681281043)
,p_plug_template_id=>wwv_flow_imp.id(103093157742575281042)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093158626004281043)
,p_plug_template_id=>wwv_flow_imp.id(103093157742575281042)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093158972569281043)
,p_plug_template_id=>wwv_flow_imp.id(103093157742575281042)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093159216643281043)
,p_plug_template_id=>wwv_flow_imp.id(103093157742575281042)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093159548291281043)
,p_plug_template_id=>wwv_flow_imp.id(103093157742575281042)
,p_name=>'Sub Regions'
