...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093187928211281054)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093188253571281054)
,p_plug_template_id=>wwv_flow_imp.id(103093187928211281054)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093188572013281054)
,p_plug_template_id=>wwv_flow_imp.id(103093187928211281054)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093188896585281055)
,p_plug_template_id=>wwv_flow_imp.id(103093187928211281054)
,p_name=>'Button Start'
