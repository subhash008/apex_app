...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093162376233281044)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093162683550281044)
,p_plug_template_id=>wwv_flow_imp.id(103093162376233281044)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093162979837281044)
,p_plug_template_id=>wwv_flow_imp.id(103093162376233281044)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093163226217281044)
,p_plug_template_id=>wwv_flow_imp.id(103093162376233281044)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093163527439281045)
,p_plug_template_id=>wwv_flow_imp.id(103093162376233281044)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093163801329281045)
,p_plug_template_id=>wwv_flow_imp.id(103093162376233281044)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
