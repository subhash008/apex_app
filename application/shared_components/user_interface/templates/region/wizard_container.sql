...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093213185819281065)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093213415632281065)
,p_plug_template_id=>wwv_flow_imp.id(103093213185819281065)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093213720165281065)
,p_plug_template_id=>wwv_flow_imp.id(103093213185819281065)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093214007546281065)
,p_plug_template_id=>wwv_flow_imp.id(103093213185819281065)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093214342718281065)
,p_plug_template_id=>wwv_flow_imp.id(103093213185819281065)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093214674154281065)
,p_plug_template_id=>wwv_flow_imp.id(103093213185819281065)
