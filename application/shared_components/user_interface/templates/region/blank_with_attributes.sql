...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093129052302281030)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093129311339281030)
,p_plug_template_id=>wwv_flow_imp.id(103093129052302281030)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093129648933281030)
,p_plug_template_id=>wwv_flow_imp.id(103093129052302281030)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093129916825281031)
,p_plug_template_id=>wwv_flow_imp.id(103093129052302281030)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093130239018281031)
,p_plug_template_id=>wwv_flow_imp.id(103093129052302281030)
,p_name=>'Sub Regions'
