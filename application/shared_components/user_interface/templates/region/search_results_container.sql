...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103093192924868281056)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093193219642281056)
,p_plug_template_id=>wwv_flow_imp.id(103093192924868281056)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093193505125281057)
,p_plug_template_id=>wwv_flow_imp.id(103093192924868281056)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093193812931281057)
,p_plug_template_id=>wwv_flow_imp.id(103093192924868281056)
,p_name=>'Sub Regions'
