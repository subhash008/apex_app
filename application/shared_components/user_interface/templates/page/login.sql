...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103093103768409281019)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093104029115281020)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093104363792281020)
,p_page_template_id=>wwv_flow_imp.id(103093103768409281019)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093104661377281020)
,p_page_template_id=>wwv_flow_imp.id(103093103768409281019)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093104907735281020)
,p_page_template_id=>wwv_flow_imp.id(103093103768409281019)
,p_name=>'Body Footer'
