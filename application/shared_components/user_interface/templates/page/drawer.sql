...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103093093101185281013)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093093457535281014)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093093753488281014)
,p_page_template_id=>wwv_flow_imp.id(103093093101185281013)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093094020742281014)
,p_page_template_id=>wwv_flow_imp.id(103093093101185281013)
