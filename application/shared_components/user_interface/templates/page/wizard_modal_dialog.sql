...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103093122356727281027)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093122645392281027)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093122951347281028)
,p_page_template_id=>wwv_flow_imp.id(103093122356727281027)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093123232513281028)
,p_page_template_id=>wwv_flow_imp.id(103093122356727281027)
