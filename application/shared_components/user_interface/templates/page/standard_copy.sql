prompt --application/shared_components/user_interface/templates/page/standard_copy
begin
--   Manifest
--     TEMPLATE: STANDARD_COPY
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103116333595102701130)
,p_theme_id=>42
,p_name=>'standard copy'
,p_internal_name=>'STANDARD_COPY'
,p_is_popup=>false
...
'  #FAVICONS#',
'  #HEAD#',
'  <link href="#APP_FILES#page2#MIN#.css" rel="stylesheet">',
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116333923315701131)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116334408437701131)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116334972999701132)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116335492731701132)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116335994478701132)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116336487233701132)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116336903953701132)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116337495321701133)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116337941785701133)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103116338469881701133)
,p_page_template_id=>wwv_flow_imp.id(103116333595102701130)
