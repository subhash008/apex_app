...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103093113701055281023)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093114095612281024)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093114395557281024)
,p_page_template_id=>wwv_flow_imp.id(103093113701055281023)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103093114648165281024)
,p_page_template_id=>wwv_flow_imp.id(103093113701055281023)
